...
export default function AgregarImagen(props) {
    ...
    const guardar = async (e) => {
        ...
        formdata.append('pertenece', idArticulo)
        const respuesta = await Axios.post('http://localhost:4000/galeria/agregarImagen', formdata, {
